                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://graviers.fneconnect.net/backend/assets/imgs/theme/logoAvecFond.jpg"
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <h1
                                                                ...
                                                                <span><span>Votre code est</span></span>
                                                            </h1>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                <div style="box-sizing: border-box;display: inline-block;text-align: center;color: #000000; background-color: #ffffff; width:60%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; border: 2px solid #000000; font-size: 24px; font-weight: 700; letter-spacing: 4px;">
                                                                    <span style="display:block;padding:12px 20px;line-height:120%;">{{ $code }}</span>
                                                                </div>
                                                            </div>
