                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu font-heading">
                            ...
                            <li class="menu-item-has-children">
                                <a href="shop-grid-right.html">Nos locaux</a>
                                <ul class="dropdown">
                                    <li><a href="shop-grid-right.html">Magasin 1</a></li>
                                    <li><a href="shop-grid-left.html">Magasin 2</a></li>
                                    <li><a href="shop-list-right.html">Magasin 3</a></li>
                                    {{-- <li><a href="shop-list-left.html">Shop List – Left Sidebar</a></li>
                                    <li><a href="shop-fullwidth.html">Shop - Wide</a></li>
                                    <li class="menu-item-has-children">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li><a href="page-account.html">Mon compte</a></li>
                                    ...
                                    <li><a href="page-terms.html">Termes de Service</a></li>
                                    {{-- <li><a href="page-404.html">404 Page</a></li> --}}
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
