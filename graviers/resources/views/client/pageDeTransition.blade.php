...
@extends('client.main')
@section('title', 'Periode de location')
@section('content')
    <main class="main">
            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="row">
                        ...
                        <span> Pour les paiement de plus de 2 000 000 fcfa, seul les paiement par virement sont autorisés. </span>
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="row shipping_calculator d-flex ">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" style="border: solid 1px grey" required name="date_operation"
                                        class=" mb-5 mt-5 form-control">
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="border p-40 cart-totals ml-30 mb-50">
                        ...
                        {{-- <label class="btn btn-fill-out btn-block mt-30" for="modePaiement">Choisir le mode de paiement<i
                                class="fi-rs-money ml-15"></i></label> --}}
                    </div>
                </div>
            </div>
        </div>
