...
{{-- @dd($detail) --}}
                    ...
                    <div class="row">
                        ...
                        <form method="post" action="{{route('client.creationTicket',$detail)}}">
                            @csrf
                            <div class="row shipping_calculator">
                                ...
                                <textarea required name="message" id="" placeholder="Veuillez expliquer en quelques mots la raison de ce retour" cols="30" class="mt-5" placeholder="" rows="10"></textarea>
