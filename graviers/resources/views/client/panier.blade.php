...
@endif
    ...
    <div class="contain-fluid bg-primary">
        <h4 class="text-white text-center">Banière</h4>
    </div>
    @include('layout.header')


<div class="container-fluid row">
    <div class="col-3">gache</div>
        ...
        <div class="card">
            <div class="row">
                @if (Cart::count() > 0)
                    ...
                    <div class="row mt-10">
                        <h3 class="text-center">Vous avez ajouté ces produits à votre panier</h3>
                    </div>
