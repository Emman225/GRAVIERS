...
<x-notify::notify />
    ...
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">Livraisons en cours</h2>
                                ...
                                @foreach ($livraisons as $key => $livraison)
                                    ...
                                    <tr>
                                            <form action="{{route('show.restaureLivraison',$livraison)}}" method="POST">
                                                @csrf
                                            <td class="texte-center"><b> {{$livraison->nom_client ?? ''}} </b></td>
                                            <td class="texte-center"><b> {{$livraison->nom_fournisseur ?? ''}} </b></td>
                                            <td class="texte-center"><b> {{$livraison->nom_livreur ?? ''}} </b></td>
                                            <td class="texte-center"> {{$livraison->adresse ?? ''}}</td>
                                            ...
                                            @else
                                                <td class="texte-center"><b> ND </b></td>
                                                <td class="texte-center"><b> ND </b></td>
                                                <td class="texte-center"><b> ND </b></td>
                                            @endif
