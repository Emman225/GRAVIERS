...
<div class="content-header">
    <div>
        <h2 class="content-title card-title">Commentaires sur les produits</h2>
        {{-- <p>Vous </p> --}}
    </div>
    <div>
        @if (session('ok'))
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="rating-stars">
                                    <li style="width: {{$note->note*20}}%" class="stars-active">
                            ...
                            <td>
                                @switch($note->statut)
                                    ...
                                    @case(2)
                                        ...
                                        @break
                                    @case(3)
                                        <span class="badge bg-danger">Avis annulé</span>
                                        @break
                                    @default
                            ...
                            <td class="text-end">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{route('show.publierCommentaire',$note->id)}}">Publier</a>
                                        <a class="dropdown-item text-danger" href="{{route('show.annulerCommentaire',$note->id)}}">Annuler</a>
                                    </div>
                                </div>
                                <!-- dropdown //end -->
                            </td>
