@extends('layout.main')
@section('title','Ajout de ville')
@section('contenu')

                <div class="content-header">
                    <div>
                        <h2 class="content-title card-title">Ville</h2>
                        <p>Ajoutez, modifiez ou supprimez une ville</p>
                    </div>
                    <div>
                            ...
                            <div class="col-md-3">
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text"  value="{{$ville->nom}}" name="nom" class="form-control" id="product_name" />
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="pays" class="form-control" id="product_name">
                                            <option value="">Pays</option>
                                            @foreach ($pays as $p )
                                                <option @selected($p->id == $ville->pays_id) value="{{$ville->id}}"> {{$ville->nom}} </option>
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                            @error('pays')
