...
@section('contenu')
        ...
        <div class="dash-welcome-content">
            ...
            <div class="dash-welcome-actions d-none d-md-flex">
                <div class="dash-time-pill">
                    ...
                    <span>Solde :&nbsp;<strong>{{ number_format((float) $livreur->solde, 0, ',', ' ') }} FCFA</strong></span>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
                    ...
                    <div class="parametre-info-grid">
                        <div class="parametre-info-row">
                            ...
                            <div class="text-start">
                                ...
                                <div class="parametre-info-value">{{ number_format((float) $livreur->solde, 0, ',', ' ') }} FCFA</div>
                            </div>
                        </div>
                        <div class="parametre-info-row">
                            <i class="material-icons md-local_shipping text-primary"></i>
                            <div class="text-start">
                                <div class="parametre-info-label">Forfait livraison</div>
                                <div class="parametre-info-value">{{ number_format((float) $livreur->prix_livraison, 0, ',', ' ') }} FCFA</div>
                            </div>
                        </div>
                        <div class="parametre-info-row">
        ...
        {{-- === FORM === --}}
        <div class="col-lg-8">
            <form method="post" action="{{ route('livreur.parametreLivreur') }}">
                @csrf
                ...
                <div class="premium-form-card mb-4">
                    <div class="premium-form-header">
                        ...
                        <p>Vos coordonnées de contact affichées sur votre profil.</p>
                    </div>
                    <div class="premium-form-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label class="premium-field-label"><i class="material-icons md-local_shipping"></i> Forfait par livraison</label>
                                <div class="input-group">
                                    <input class="form-control fw-bold text-center" disabled type="text"
                                           value="{{ number_format((float) $livreur->prix_livraison, 0, ',', ' ') }}" />
                                    <span class="input-group-text">FCFA / livraison</span>
                                </div>
                                <div class="form-text">Tarif défini par l'administrateur, non modifiable.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('livreur.home') }}" class="btn btn-light">
