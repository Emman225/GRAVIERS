                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="icontext">
                                                        <img class="icon border" src="{{asset('backend/assets/imgs/card-brands/1.png')}}" alt="Payment" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="icontext">
                                                        <img class="icon border" src="{{asset('backend/assets/imgs/card-brands/2.png')}}" alt="Payment" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="icontext">
                                                        <img class="icon border" src="{{asset('backend/assets/imgs/card-brands/3.png')}}" alt="Payment" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="icontext">
                                                        <img class="icon border" src="{{asset('backend/assets/imgs/card-brands/4.png')}}" alt="Payment" />
