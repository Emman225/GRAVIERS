...
@section('contenu')
    ...
    <div class="content-header">
        <div>
            ...
            <p class="bg-warning text-black p-2 fw-bold text-center">Cette commande n'est pas à livrer, le client le récupe lui même</p>
        </div>
    </div>
    <div class="card">
                                    ...
                                    @if ($produit->pivot->statut != 2)
                                        ...
                                        @if ($qteFournisseur > 0)
                                            @if ($qteRestant > 0)
                                                <tr>
                                                    <form id="ok"
                                                        action="{{ route('orders.traitement.sansLivraison.post', ['commande' => $commande, 'produit' => $produit]) }}"
                                                        method="post">
                                                        @csrf
                                                        <td>
