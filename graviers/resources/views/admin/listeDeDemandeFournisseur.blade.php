                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @elseif($estEnAttente1)
                                                            <a href="{{route('show.valideDemande',['id'=>$demande->id, 'type' => 'fournisseur','reponse' => 'accepter'])}}" class="btn btn-sm font-sm rounded btn-success"><i class="material-icons md-check"></i> 1re validation</a>
                                                        ...
                                                        @elseif($estEnAttente2)
                                                            <a href="{{route('show.valideDemande',['id'=>$demande->id, 'type' => 'fournisseur','reponse' => 'accepter'])}}" class="btn btn-sm font-sm rounded btn-success"><i class="material-icons md-check"></i> 2e validation (accepter)</a>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if($estDejaFinalisee)
                                                            —
                                                        @elseif($estEnAttente2 && !$estInitiateur)
                                                            <a href="{{route('show.valideDemande',['id'=>$demande->id, 'type' => 'fournisseur','reponse' => 'refuser'])}}" class="btn btn-sm font-sm rounded btn-danger" onclick="return confirm('Refuser cette demande ?');"><i class="material-icons md-denied"></i> Rejeter</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endif
