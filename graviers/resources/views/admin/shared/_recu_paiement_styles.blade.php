{{-- Variables : $isPdf (bool), $couleur (string css) --}}
<style>
    @if (!$isPdf)
    @media print {
    ...
    .recu-header { border-bottom: 2px solid {{ $couleur }}; padding-bottom: 8px; margin-bottom: 10px; }
    ...
    .recu-head-info h1 { color: {{ $couleur }}; margin: 0 0 3px; font-size: 16px; letter-spacing: 0.5px; line-height: 1.1; }
    ...
    .recu-numero { background: {{ $couleur }}; color: white; padding: 6px 10px; text-align: center; font-size: 12px; font-weight: bold; letter-spacing: 0.8px; margin: 8px 0 6px; border-radius: 3px; }
    .recu-numero small { color: #fff; opacity: 0.85; font-weight: normal; font-size: 9px; }
    ...
    .recu-montant { background: #e8f4ff; border: 1.5px solid {{ $couleur }}; padding: 8px; text-align: center; margin: 8px 0; border-radius: 4px; }
    .recu-montant-label { color: #555; font-size: 9px; text-transform: uppercase; }
    .recu-montant-value { color: {{ $couleur }}; font-size: 18px; font-weight: bold; margin: 2px 0; }
