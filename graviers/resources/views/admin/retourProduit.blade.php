                ...
                <table class="table table-striped" id="liste">
                    ...
                    <tbody>
                        @foreach ($retours as $retour )
                            <tr>
                                <td class="text-center" > {{$retour->client?->nom}} </td>

                                <td class="text-center"> {{$retour->detailCommande?->commande?->numero ?? '-'}} </td>
                                ...
                                <td class="text-center">
                                    ...
                                    @switch($retour->statut)
                                        ...
                                        <span class="badge badge-warning bg-success text-white">Approuvé</span>
                                            @break
                                        @case(3)
                                        <span class="badge badge-warning bg-danger text-white">Réfusé</span>
                                            @break
