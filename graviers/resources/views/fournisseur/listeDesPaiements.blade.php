...
@php
    ...
    $solde = (float) ($fournisseur->solde ?? 0);
@endphp
...
@section('contenu')
    ...
    <div class="dash-welcome mb-4">
        <div class="dash-welcome-content">
            <div>
                <h2 class="dash-welcome-title">État de mes paiements</h2>
                <p class="dash-welcome-subtitle">Historique de vos demandes de paiement et leur statut de traitement.</p>
            </div>
            <div class="dash-welcome-actions d-none d-md-flex gap-2">
                <a href="{{ route('sellers.demandeDepaieFournisseur') }}" class="btn btn-primary btn-sm">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="kpi-card kpi-card-warning">
                ...
                <div class="kpi-card-body">
                    <div class="kpi-card-label">Non payées</div>
                    <div class="kpi-card-value">{{ $totalNonPayees }}</div>
